...
echo -e "     ${BICyan}[${BIWhite}03${BICyan}] VLESS   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "     ${BICyan}[${BIWhite}08${BICyan}] ADD-HOST  ${BICyan}[${BIYellow}ON${BICyan}]${NC}" "${BICyan}   │"
echo -e "     ${BICyan}[${BIWhite}04${BICyan}] TROJAN  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "     ${BICyan}[${BIWhite}09${BICyan}] RUNNING   ${BICyan}[${BIYellow}ON${BICyan}]${NC}" "${BICyan}   │"                                               │"
...
echo -e " ${BICyan}│  Day Expired${NC}   : $exp2"
echo -e " ${BICyan}└─────────────────────────────────────┘${NC}"
echo

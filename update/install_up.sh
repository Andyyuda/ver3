...
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/Andyyuda/ver3/main/ssh/usernew.sh" && chmod +x /usr/bin/usernew
...
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/Andyyuda/ver3/main/menu/menu-vless.sh" && chmod +x /usr/bin/menu-vless
...
wget -q -O /usr/bin/autobackup "https://raw.githubusercontent.com/Andyyuda/ver3/main/backup/autobackup.sh" && chmod +x /usr/bin/autobackup
wget -q -O /usr/bin/set-br "https://raw.githubusercontent.com/Andyyuda/ver3/main/backup/set-br.sh" && chmod +x /usr/bin/set-br
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/Andyyuda/v3/main/ssh/usernew.sh" && chmod +x /usr/bin/usernew
...
wget -q -O /usr/bin/add-ws "https://raw.githubusercontent.com/artanodrop/v4/main/xray/add-ws.sh" && chmod +x /usr/bin/add-ws
wget -q -O /usr/bin/cek-ws "https://raw.githubusercontent.com/artanodrop/v4/main/xray/cek-ws.sh" && chmod +x /usr/bin/cek-ws
wget -q -O /usr/bin/renew-ws "https://raw.githubusercontent.com/artanodrop/v4/main/xray/renew-ws.sh" && chmod +x /usr/bin/renew-ws

...
#wget -q -O /usr/bin/menu-set "https://raw.githubusercontent.com/artanodrop/dxavier/main/update/menu-set.sh" && chmod +x /usr/bin/menu-set
...
wget -q -O /usr/bin/menu-backup "https://raw.githubusercontent.com/artanodrop/dxavier/main/update/menu-backup.sh" && chmod +x /usr/bin/menu-backup
